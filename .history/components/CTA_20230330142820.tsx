  ...
  return (
    <div>
      <section className="relative py-12 overflow-hidden sm:py-16 lg:py-20">
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8 border-2 rounded-2xl">
          <div className="text-center lg:w-1/2 xl:w-2/5 lg:text-left lg:pr-8 py-8 border-2">
