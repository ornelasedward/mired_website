  ...
  return (
    <div className="bg-white">
      <div className="relative px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div className="grid grid-cols-1 bg-[#F5F5F5] border-gray-800">
          <div className="">
            <div className="p-6 sm:px-8">
              <p className="mt-12 text-xl border-gray-200 font-normal text-white lg:mt-32 xl:mt-52">
                Create a free account. Amet minim mollit non est sit dolor do.
              </p>
            </div>
          </div>

          <div className="border-t border-gray-200 sm:border-t-0 sm:border-l">
            <div className="p-6 sm:px-8">
