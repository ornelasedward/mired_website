      ...
      <section className="pt-12 bg-gray-50 sm:pt-16">
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
          <div className="max-w-2xl mx-auto text-center">
            <p className="mt-5 text-4xl font-normal leading-tight text-gray-900 sm:leading-tight sm:text-5xl lg:text-6xl lg:leading-tight font-pj">
            ...
            <h1 className="px-6 text-lg text-gray-600 font-inter">
              Get the website you&apos;ve always wanted and the conversions you
              deserve with our full-service agency.
            </h1>
