...
const FAQ = () => {
  ...
  return (
    <section className="py-12 sm:py-16 lg:py-20">
      ...
      <h3>
        <button onClick={() => setExpanded(!expanded)} className="flex items-center justify-between w-full px-6 py-5 text-xl font-bold text-left text-gray-900 sm:p-8 font-pj">
      ...
      <div className={`${expanded ? "block" : "hidden"} px-6 pb-6 sm:px-8 sm:pb-8`} >
