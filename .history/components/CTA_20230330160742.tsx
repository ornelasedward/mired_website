  ...
  return (
    <div>
      <section className="relative py-12 overflow-hidden sm:py-16 lg:py-20">
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8 border-2 rounded-2xl bg-[#161616] overflow-hidden">
        ...
        <div className="mt-16 translate-x-12 lg:absolute lg:bottom-0 lg:right-0 lg:translate-x-96 lg:translate-y-8 xl:translate-x-20 2xl:translate-x-44 2xl:translate-y-24 overflow-hidden">
          <div className="relative overflow-hidden">
            <div className="absolute -inset-2 overflow-hidden">
              <div
                className="w-full h-full mx-auto opacity-30 blur-lg filter overflow-hidden"
                style={{
                  background:
            ...
            <div className="relative overflow-hidden">
              <div className="aspect-w-16 aspect-h-12 lg:aspect-none overflow-hidden">
                <Image
                  className="object-cover object-left-top w-full h-full lg:max-w-4xl 2xl:max-w-5xl overflow-hidden"
                  src={Dashboard}
                  alt=""
                />
              </div>
