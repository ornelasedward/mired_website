      ...
      <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="grid max-w-6xl grid-cols-1 mx-auto gap-y-12 lg:grid-cols-2 lg:gap-x-16 xl:gap-x-24">
          ...
          <div className="relative flex items-center justify-center">
            <div className="absolute right-1/4 transform translate-x-4 -translate-y-1/2 top-1/2 bg-gradient-to-br from-[#F7BE08] to-[#55F5A3] w-full h-full blur-xl opacity-50" />
