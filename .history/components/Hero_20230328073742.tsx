          ...
          <div className="flex items-center justify-between">
            ...
            <div className="hidden lg:ml-auto lg:flex lg:items-center lg:space-x-10">
              <Link
                href="#"
                title=""
                className="inline-flex items-center justify-center px-6 py-3 text-base font-bold leading-7 text-black transition-all duration-200 bg-transparent border-[2px] border-black rounded-2xl font-inter focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900"
                role="button"
              >
                Work with us
              </Link>
