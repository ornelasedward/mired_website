  ...
  return (
    <div>
      <section className="relative py-12 overflow-hidden sm:py-16 lg:py-20">
        <div className="px-4 mx-auto max-w-8xl sm:px-6 lg:px-8 border-2 rounded-2xl bg-[#161616]">
          <div className="text-center lg:w-1/2 xl:w-2/5 lg:text-left lg:pr-8 py-8">
            <h2 className="mt-6 text-3xl font-bold text-[#F6F3EC] sm:text-4xl xl:text-5xl font-pj">
