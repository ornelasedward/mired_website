  ...
  return (
    <div>
      <section className="relative py-12 overflow-hidden sm:py-16 lg:py-20">
        ...
        <div className="mt-16 translate-x-12 lg:absolute lg:bottom-0 lg:right-0 lg:translate-x-96 lg:translate-y-8 xl:translate-x-20 2xl:translate-x-44 2xl:translate-y-10">
