        ...
        <div className="max-w-4xl mx-auto mt-8 sm:mt-14">
          <div x-data="{ active: 1 }" className="space-y-4">
            ...
            >
              <h3>
                <button className="flex items-center justify-between w-full px-6 py-5 text-xl font-bold text-left text-gray-900 sm:p-8 font-pj">
                  <span> What is Conversion Rate Optimization? </span>
                  <span x-show="expanded" aria-hidden="true" className="ml-4">
                    <svg
                      className="w-6 h-6 text-gray-900"
                      xmlns="http://www.w3.org/2000/svg"
              ...
              <div x-show="expanded" x-collapse>
                <div className="px-6 pb-6 sm:px-8 sm:pb-8">
                  Conversion Rate Optimization, also known as CRO, is a
                  methodical process that aims to boost the proportion of
                  website visitors who fulfill your website's particular goals
                  and requirements, known as KPIs, or more broadly, take any
                  preferred action on a webpage. This strategy relies on
                  insights derived from analytics and user feedback to inform
