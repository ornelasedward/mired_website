...
export default function Services() {
  return (
    <div>
      <div className="absolute transform -translate-x-1/2 translate-y-full bottom-1/2 left-1/2"></div>

      <div className="absolute inset-0">
        {/* <Image className="object-cover w-full h-full opacity-50" src="https://landingfoliocom.imgix.net/store/collection/dusk/images/noise.png" alt="" width="100" height="100"> */}
      </div>
