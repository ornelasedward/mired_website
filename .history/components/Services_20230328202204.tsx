          ...
          <div className="bg-[#F5F5F5]">
            <div className="grid md:grid-cols-5 grid-cols-1">
              <div className="col-span-3 flex items-center max-w-2xl">
                <div className="px-8 py-8 flex flex-col lg:gap-8 gap-6 lg:max-w-2xl">
                  <h1 className="xl:text-5xl lg:text-4xl text-2xl font-normal text-black">
                    Web Design & Development
                  </h1>
                  <p className="text-md font-light lg:leading-9 leading-6">
