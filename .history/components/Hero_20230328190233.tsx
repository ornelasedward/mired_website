  ...
  return (
    <div className="overflow-x-hidden">
      ...
      <section className="pt-12 sm:pt-16">
        ...
        <div className="absolute bottom-1/2 left-1/2 w-2/3 h-full rounded-full bg-[#55F5A3] opacity-80 blur-3xl filter -z-10" />
        <div className="absolute bottom-1/2 left-1/2 w-full h-32 rounded-full bg-[#F1CB00] opacity-40 blur-3xl filter -z-10" />
        <div className="py-12">
          <div className="">
            <Image
              className="m-auto"
