  ...
  return (
    <div>
      <section className="relative py-12 overflow-hidden sm:py-16 lg:py-20">
        ...
        <div className="mt-16 translate-x-12 lg:absolute lg:bottom-0 lg:right-0 lg:-translate-y-32 lg:-translate-x-42">
          <div className="relative">
            ...
            <div className="relative">
              <div className="aspect-w-16 aspect-h-12 lg:aspect-none">
                <Image
                  className="object-cover object-left-top w-[500px] h-full lg:max-w-4xl 2xl:max-w-5xl"
                  src={Dashboard}
                  alt=""
                />
              </div>
