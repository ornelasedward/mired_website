  ...
  return (
    <div className="overflow-x-hidden ">
      <header className="py-4 md:py-6" x-data="{expanded: false}">
        <div className="container px-4 mx-auto sm:px-6 lg:px-8 absolute top-0 -right-4 hidden h-[200px] w-auto animate-blob rounded-full bg-[#F1CB00] opacity-40  blur-3xl filter lg:block">
